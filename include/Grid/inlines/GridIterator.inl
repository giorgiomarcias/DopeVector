...
namespace container {
    ...
    template < typename T, SizeType Dimension >
    inline GridIterator<T, Dimension> operator+(const SizeType n, const self_type &it) {
        return (it + n);
    }
    ...
    template < typename T, SizeType Dimension >
    inline GridIterator<T, Dimension> operator+(const IndexD &n, const self_type &it) {
        return (it + n);
    }
